...
<head>
	...
	<link rel="stylesheet" type="text/css" href="driver signup style.css">
...
<body>
    ...
    padding: 70px 30px;
		...
		<section class='form'>
			<form action="driver signup insert.php" method="post" novalidate>
				<fieldset>
					<div class="field">
						<label>
							<span style="color:white">First Name</span>
							<input  name="fname" onkeyup="lettersonly(this)" placeholder="ex. John" required="required" />
						</label>
					</div>
					<div class="field">
						<label>
							<span style="color:white">Last Name</span>
							<input name="lname" onkeyup="lettersonly(this)" placeholder="ex. Kennedy" required="required" />
						</label>
					</div>
					<div class="field"> 
						<label>
							<span style="color:white">User Name</span>
							<input  name="dname" placeholder="ex. John13" pattern=".{5,10}" title="Enter 5-10 characters containing both numbers and letters" required="required" />
						</label>
					</div>
					...
					<div class="field">
						<label>
							...
							<input name="exp" onkeyup="numbersonly(this)" class='email' required="required" type="text" />
						</label>
					</div>
					...
					<div class="field">
						<label>
							...
							<input class='date' onkeyup="numbersonly(this)" type="text" name="fee" required='required'>
						</label>
					</div>
					...
					<div class="field">
						<label>
							...
							<input type="tel" onkeyup="numbersonly(this)" class='tel' name="phone" required='required' data-validate-length-range="8,20">
						</label>
						<div class='tooltip help'>
							<span>?</span>
							<div class='content'>
								<b></b>
								<p>A phone number can start with a '+' sign</p>
							</div>
						</div>
					</div>
					...
					<div class="field">
						<label>
							<span style="color:white">Photo upload</span>
							<input type='file' name="photo" >
						</label>
					</div>
					<div class="field">
						<label>
							<span style="color:white">License upload</span>
				...
				<button type="submit" name="savee" >Submit</button>
